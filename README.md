...
**SimpleTweetp** is an android app that allows a user to view their Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [X] List anything else that you can get done to improve the app functionality!
	- Clicking on embedded images launches imageactivity that shows image in full screen
	- Favorite and retweet counts can be seen in timeline and details mode
		- Along with corresponding icons, that change if the tweet is favorited or retweeted (or not)
